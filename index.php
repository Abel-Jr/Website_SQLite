<!DOCTYPE html>
    ...
    <html>
        <head>
            ...
            <title>Accueil_AIServices</title>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    <a class="nav-item nav-link active" href="#"><b>Accueil</b><span class="sr-only">(current)</span></a>
      ...
      <div class="container">
        <div class="row align-items-start">
          <div class="col">
            <div class="thumbnail">
            <a href="contact.php">
              <img src="responsable-service-client.jpg" alt="Que recherchez vous" height="300" width="300">
              <div class="caption">
                <p>Services Client</p>
              </div>
              </a>
          ...
          <div class="col">
            <div class="thumbnail">
              ...
              <img src="qui-sommes-nous-compressor-700x525.jpg" alt="Que recherchez vous" height="300" width="300">
              <div class="caption">
                <p>Rejoignez nous</p>
              </div>
              </a>
          ...
          <div class="col">
            ...
            <div class="thumbnail">
              ...
              <img src="what-are-you-looking-for.jpg" alt="Que recherchez vous" height="300" width="300">
              <div class="caption">
